...
# =========================
if "Act Tm" in deliveries.columns:
    deliveries["Before_12"] = deliveries["Act Tm"].apply(
        lambda x: x.hour < 12 if pd.notnull(x) else False
    )
else:
    deliveries["Before_12"] = False

# =========================
# 6. EXCEPTION FLAG (IMPROVED)
# =========================
